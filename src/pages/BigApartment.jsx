...
function BigApartment() {
  ...
  useEffect(() => {
    instance
      .get("/roomDetails", { params: { type: "Big Apartment" } })
      .then((res) => {
  ...
  useEffect(() => {
    const payment = 160 * 100 * details.dates.length * details.rooms || 0;
            ...
            onSubmit={(e) => {
              ...
              instance
                .get("/paymentOrder", {
                  params: {
                    amount: cost,
                    data: { ...details, amount: cost, room: "Big Apartment" },
                  },
                })
                .then((res) => {
